...
return [
    ...
    'bookshelf_color' => 'Cor do Módulo',
    'book_color' => 'Cor do Procedimento',
    ...
    'maint_recycle_bin_desc' => 'Módulos, procedimentos, capítulos e páginas deletados são mandados para a lixeira podendo assim ser restaurados ou excluídos permanentemente. Itens mais antigos da lixeira podem vir a ser automaticamente removidos da lixeira após um tempo dependendo da configuração do sistema.',
    ...
    'role_manage_entity_permissions' => 'Gerenciar todos os procedimentos, módulos e permissões de páginas',
    'role_manage_own_entity_permissions' => 'Gerenciar permissões de seu próprio procedimento, módulo e paginas',
    ...
    'role_asset_desc' => 'Essas permissões controlam o acesso padrão para os ativos dentro do sistema. Permissões em Procedimentos, Módulos e Páginas serão sobrescritas por essas permissões.',
