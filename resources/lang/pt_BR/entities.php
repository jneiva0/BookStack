...
return [
    ...
    'recently_created_books' => 'Procedimentos Criados Recentemente',
    'recently_created_shelves' => 'Módulos Criadas Recentemente',
    ...
    'shelf' => 'Módulo',
    'shelves' => 'Módulos',
    'x_shelves' => ':count Módulo|:count Módulos',
    'shelves_long' => 'Módulos de Procedimentos',
    'shelves_empty' => 'Nenhuma  foi criada',
    'shelves_create' => 'Criar Novo Módulo',
    'shelves_popular' => 'Módulos Populares',
    'shelves_new' => 'Módulos Novas',
    'shelves_new_action' => 'Novo Módulo',
    'shelves_popular_empty' => 'As s mais populares aparecerão aqui.',
    'shelves_new_empty' => 'As s criadas mais recentemente aparecerão aqui.',
    'shelves_save' => 'Salvar Módulo',
    'shelves_books' => 'Procedimentos nesta ',
    'shelves_add_books' => 'Adicionar procedimentos a esta ',
    'shelves_drag_books' => 'Arraste procedimentos aqui para adicioná-los a esta ',
    'shelves_empty_contents' => 'Esta  não possui procedimentos atribuídos a ela',
    'shelves_edit_and_assign' => 'Editar  para atribuir procedimentos',
    'shelves_edit_named' => 'Editar Módulo de Procedimentos :name',
    'shelves_edit' => 'Edit Módulo de Procedimentos',
    'shelves_delete' => 'Excluir Módulo de Procedimentos',
    'shelves_delete_named' => 'Excluir Módulo de Procedimentos :name',
    'shelves_delete_explain' => "A ação vai excluír o módulo com o nome ':name'. Procedimentos contidos não serão excluídos.",
    'shelves_delete_confirmation' => 'Você tem certeza que quer excluir esta  de procedimentos?',
    'shelves_permissions' => 'Permissões do Módulo',
    'shelves_permissions_updated' => 'Permissões do Módulo Atualizadas',
    'shelves_permissions_active' => 'Permissões do Módulo Ativas',
    'shelves_copy_permissions_to_books' => 'Copiar Permissões para Procedimentos',
    'shelves_copy_permissions' => 'Copiar Permissões',
    'shelves_copy_permissions_explain' => 'Isto aplicará as configurações de permissões atuais desta  a todos os procedimentos contidos nela. Antes de ativar, assegure-se de que quaisquer alterações nas permissões deste módulo tenham sido salvas.',
    'shelves_copy_permission_success' => 'Permissões da  copiadas para :count procedimentos',

    // Books
    'book' => 'Procedimento',
    'books' => 'Procedimentos',
    'x_books' => ':count Procedimento|:count Procedimentos',
    'books_empty' => 'Nenhum procedimento foi criado',
    'books_popular' => 'Procedimentos Populares',
    'books_recent' => 'Procedimentos Recentes',
    'books_new' => 'Procedimentos Novos',
    'books_new_action' => 'Novo Procedimento',
    'books_popular_empty' => 'Os procedimentos mais populares aparecerão aqui.',
    'books_new_empty' => 'Os procedimentos criados mais recentemente aparecerão aqui.',
    'books_create' => 'Criar Novo Procedimento',
    'books_delete' => 'Excluir Procedimento',
    'books_delete_named' => 'Excluir Procedimento :bookName',
    'books_delete_explain' => 'A ação vai excluir o procedimento com o nome \':bookName\'. Todas as páginas e capítulos serão removidos.',
    'books_delete_confirmation' => 'Você tem certeza que quer excluir o Procedimento?',
    'books_edit' => 'Editar Procedimento',
    'books_edit_named' => 'Editar Procedimento :bookName',
    'books_form_book_name' => 'Nome do Procedimento',
    'books_save' => 'Salvar Procedimento',
    'books_permissions' => 'Permissões do Procedimento',
    'books_permissions_updated' => 'Permissões do Procedimento Atualizadas',
    'books_empty_contents' => 'Nenhuma página ou capítulo foram criados para este procedimento.',
    'books_empty_create_page' => 'Criar uma nova página',
    'books_empty_sort_current_book' => 'Ordenar o procedimento atual',
    'books_empty_add_chapter' => 'Adicionar um capítulo',
    'books_permissions_active' => 'Permissões do Procedimento Ativas',
    'books_search_this' => 'Pesquisar neste procedimento',
    'books_navigation' => 'Navegação do Procedimento',
    'books_sort' => 'Ordenar Conteúdos do Procedimento',
    'books_sort_named' => 'Ordenar Procedimento :bookName',
    ...
    'books_sort_show_other' => 'Mostrar Outros Procedimentos',
    ...
    'book_tags' => 'Tags de Procedimento',
    'shelf_tags' => 'Tags de Módulo',
    'tag' => 'Tag',
    'tags' =>  'Tags',
    ...
    'profile_not_created_books' => ':userName não criou procedimentos',
    'profile_not_created_shelves' => ':userName não criou s',
